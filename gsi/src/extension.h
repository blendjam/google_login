...
// Lua API.
#define EXTENSION_LOGIN FUNCTION_NAME_EXPANDED(EXTENSION_NAME, login)
        int EXTENSION_LOGIN(lua_State* L);
#define EXTENSION_GET_SERVER_AUTH_CODE FUNCTION_NAME_EXPANDED(EXTENSION_NAME, get_server_auth_code)
        int EXTENSION_GET_SERVER_AUTH_CODE(lua_State* L);
#define EXTENSION_LOGOUT FUNCTION_NAME_EXPANDED(EXTENSION_NAME, logout)
